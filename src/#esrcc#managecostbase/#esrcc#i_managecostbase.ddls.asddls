...
define root view entity /ESRCC/I_MANAGECOSTBASE
  ...
  association [0..1] to /ESRCC/I_LEGALENTITY_F4   as legalentity       on  legalentity.Legalentity = ManageCostBase.legalentity

  association [0..1] to /ESRCC/I_COMPANYCODES_F4  as ccode             on  ccode.Ccode       = ManageCostBase.ccode
                                                                       and ccode.Sysid       = $projection.SysID
                                                                       and ccode.Legalentity = $projection.Legalentity

  association [0..1] to /ESRCC/I_COSTOBJECTS      as costobject        on  costobject.Costobject = ManageCostBase.costobject

  association [0..1] to /ESRCC/I_COSCEN_F4        as costcenter        on  costcenter.CompanyCode      = $projection.Ccode
                                                                       and costcenter.LegalEntity = $projection.Legalentity
  ...
  association [0..1] to /ESRCC/I_BUSINESSDIV_F4   as _businessdiv      on  _businessdiv.BusinessDivision = ManageCostBase.businessdivision

  association [0..1] to /ESRCC/I_PROFITCENTER_F4  as _profitcenter     on  _profitcenter.ProfitCenter = ManageCostBase.profitcenter
