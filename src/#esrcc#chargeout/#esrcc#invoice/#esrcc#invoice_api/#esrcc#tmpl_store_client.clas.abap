CLASS /esrcc/tmpl_store_client DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /ESRCC/TMPL_STORE_CLIENT IMPLEMENTATION.
...
*    ENDTRY.
  ...
  METHOD get_schema_by_name.
    ...
    if lr_data is bound.
      ...
      if <schema> is assigned.
        ...
        raise EXCEPTION type /ESRCC/cx_fp_tmpl_store_error
          EXPORTING
            mv_http_status_code = 404
            mv_http_reason = 'No schema maintained for form'
            textid = /ESRCC/cx_fp_tmpl_store_error=>data_error.
      endif.
  ...
  METHOD set_form.
    ...
    try.
      ...
      lv_exists = abap_true.
    catch /ESRCC/cx_fp_tmpl_store_error into data(lo_data_error).
  ...
  METHOD __execute.
    try.
      ...
      RAISE EXCEPTION type /ESRCC/cx_fp_tmpl_store_error
        EXPORTING
          textid = /ESRCC/cx_fp_tmpl_store_error=>http_client_error
