...
CLASS LHC_RAP_TDAT_CTS IMPLEMENTATION.
  METHOD GET.
    result = mbc_cp_api=>rap_table_cts( table_entity_relations = VALUE #(
                                         ( entity = 'LeAddress' table = '/ESRCC/LE_ADDRES' )
                                       ) ).
  ENDMETHOD.
ENDCLASS.
...
*        IMPORTING
*          KEYS FOR ACTION LeAddressAll~SelectCustomizingTransptReq
*        RESULT result,
...
*  ENDMETHOD.
  METHOD GET_GLOBAL_AUTHORIZATIONS.
    AUTHORITY-CHECK OBJECT 'S_TABU_NAM' ID 'TABLE' FIELD '/ESRCC/I_LEADDRESS' ID 'ACTVT' FIELD '02'.
...
*        IMPORTING
*          KEYS FOR LeAddress~ValidateRecordChanges,
