...
define view entity /ESRCC/I_BUSINESSDIV_F4
  ...
  association [0..1] to /esrcc/bus_divt as businessdivt on  businessdiv.business_divison = businessdivt.business_division
                                                        and businessdivt.spras           = $session.system_language
{
      @Search.defaultSearchElement: true
      @Search.fuzzinessThreshold: 0.7
      @ObjectModel.text.element: ['Description']
  key business_divison         as BusinessDivision,
